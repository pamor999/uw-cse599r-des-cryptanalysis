...
public class DesImpl {
  ...
  // Number of left shifts for each round of DES
  ...
  // inverse initial permutation InvIP
  ...
  // DES function E(R) for Feistel round
  ...
  public BitSet DesEncBlock(BitSet P, BitSet K, int numRounds){
	  ...
	  if (numRounds > 16) {
	     throw new IllegalArgumentException("The code does not support more than 16 rounds of DES");
	  }
